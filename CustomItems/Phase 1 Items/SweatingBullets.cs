...
{
    class SweatingBullets : PlayerItem
    {
        //Call this method from the Start() method of your ETGModule extension
        public static void Init()
        {
            string itemName = "Sweating Bullets"; //The name of the item
            string resourceName = "CustomItems/Resources/P1/sweating_bullets_icon"; //Refers to an embedded png in the project. Make sure to embed your resources!

            //Create new GameObject
            GameObject obj = new GameObject();

            //Add a ActiveItem component to the object
            var item = obj.AddComponent<SweatingBullets>();
